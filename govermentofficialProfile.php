...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            $stmt = $conn->prepare("insert into government_officials (first_name,middle_name,last_name,img_url,id_no,alternative_email,phone_no,county,region,
area,description,position_,role,owner_id)
 values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            $stmt->bind_param("ssssssssssssss",$fist_name,$middle_name,$last_name,$target_file,
...
<div  class="container-fluid">
    <div class="row justify-content-center mt-5">
        ...
        <div class="col-4  justify-content-center">
            ...
            <img src="images/images/add_image.png" class="rounded rounded-circle img mt-5 shadow-lg" width="300" height="300">
            </div>
    ...
    <div class="row mt-5 justify-content-center">
        <form class="col-sm-12 col-md-10 col-lg-9 col-xl-8 align-self-center" action="<?php echo $_SERVER["PHP_SELF"];?> " method="post" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center">
                ...
                <textarea class="form-control " width="100" required name="description">
