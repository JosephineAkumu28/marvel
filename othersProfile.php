...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            $stmt = $conn->prepare("insert into marvel_others_profile (first_name,middle_name,last_name,img_url,id_no,alternative_email,phone_no,county,region,area,description,field,role,position_,owner_id) 
 values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            $stmt->bind_param("sssssssssssssss",$fist_name,$middle_name,$last_name,$target_file,
                $id_number,$alternative_email,$phone_no,$county,$region,$area,$description,$field,$role,$position,$_SESSION["ID"]);
            if($stmt->execute()){
    ...
    <div class="row mt-5 justify-content-center">
        <form class="col-sm-12 col-md-10 col-lg-9 col-xl-8 align-self-center" action="<?php echo $_SERVER["PHP_SELF"];?> " method="post" enctype="multipart/form-data">
            ...
            <div class="row justify-content-around">
                <div class="col-sm-11 col-md-5 col-lg-3 col-xl-3">
                    <div class="form-group">
                        ...
                        <input class="form-control " type="text" required name="field">
                    </div>
                </div>
                <div class="col-sm-11 col-md-5 col-lg-3 col-xl-3">
                    <div class="form-group">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-10">
                <textarea class="form-control align-self-center" name="description" required>
