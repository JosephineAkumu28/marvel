            ...
            <div class="row justify-content-around">
                ...
                <div class="col-sm-11 col-md-11 col-lg-3 col-xl-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" required value="<?php echo $last_name;?>" name="last_name">
                    </div>
                </div>
            ...
            <div class="row justify-content-around">
                    ...
                    <div class="col-md-6 col-sm-11 col-lg-6 col-xl-6">
                        <div class="form-group ">
                            ...
                            <input class="form-control align-self-end" type="email" value="<?php echo $alternative_email;?>" required name="alternative_email">
                        </div>
                    </div>
            </div>
