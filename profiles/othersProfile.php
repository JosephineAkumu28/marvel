...
$stmt = $conn->prepare("insert into marvel_others_profile (first_name,middle_name,last_name,id_no,alternative_email,phone_no,county,region,area,description,field,role,position_,owner_id) 
 values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
